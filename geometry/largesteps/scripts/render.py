...
class NVDRenderer:
    ...
    """
    def __init__(self, scene_params, shading=True, boost=1.0, black_background=False):
        """
    ...
    def render(self, v, n, f):
        ...
        if self.shading:
            ...
            result = dr.antialias(torch.where(rast[..., -1:] != 0, col, bg), rast, v_ndc, f, pos_gradient_boost=self.boost)
        else:
